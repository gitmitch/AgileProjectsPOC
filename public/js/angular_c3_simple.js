// modified this to handle a chart id that is interpolated
// original from https://github.com/wasilak/angular-c3-simple
// modified after reading this: http://stackoverflow.com/questions/23037809/ng-attr-not-evaluating-on-directive-element
    ...
    .directive('c3Simple', ['c3SimpleService', function(c3SimpleService) {
        return {
          ...
          controller: function($scope, $element) {
            ...
            $scope.config.bindto = '#' + $scope.chartid;
